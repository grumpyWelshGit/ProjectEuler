...
class MathLibTest {
  ...
  void assertDigitalSumAsExpected() {
	...
	void assertGcd() {
		...
		assertEquals(2, Mathlib.gcd(2,12));
		assertEquals(2, Mathlib.gcd(0, 2,12));
		assertEquals(7, Mathlib.gcd(0, 7, 7));
		assertEquals(3, Mathlib.gcd(9, 21, 18));
		assertEquals(1, Mathlib.gcd(1l, 12l));
		assertEquals(2, Mathlib.gcd(2l, 12l));
		assertEquals(3, Mathlib.gcd(9l,-21l, -18l));
		long expected = 31;
		long v1 = expected * 97;
		long v2 = expected * 101;
		long v3 = expected * 13 * 17 * -11;
		assertEquals(expected, Mathlib.gcd(v1,v2, v3));
	}
}
