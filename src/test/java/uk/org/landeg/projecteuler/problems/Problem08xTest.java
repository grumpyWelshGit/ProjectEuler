...
class Problem08xTest {
  ...
  void assertProblem085Solution() {
    ...
    @Test
    void assertProblem087Solution () {
        assertEquals(1097343, new Problem087().solve().intValue());
    }

    @Test
    void assertProblem088Solution () {
